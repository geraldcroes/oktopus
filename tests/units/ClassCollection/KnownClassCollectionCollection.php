...
class KnownClassCollectionCollection extends atoum\test
{
    public function test__construct()
    {
        $this->assert
                ->object($tested = new \Oktopus\ClassCollection\KnownClassCollectionCollection());
    }
    ...
    public function testGetPath()
    {
        ...
        $collection = new \Oktopus\ClassCollection\KnownClassCollectionCollection();
